...
const varieties = [
  { id: "66f5692", imageId: "87f2460", headingId: "47dff6d", boxed: false, icon: "/icon-mango.svg", name: "sindhri" },
  { id: "6667e8e", imageId: "2080a40", headingId: "158858a", boxed: true, icon: "/icon-mango.svg", name: "chaunsa" },
  { id: "fe3d799", imageId: "ea6f660", headingId: "cc7ef5b", boxed: true, icon: "/icon-mango.svg", name: "anwar ratol" },
  { id: "4f5f6ed", imageId: "177d812", headingId: "a76ffdf", boxed: true, icon: "/icon-mango.svg", name: "langra" },
  { id: "50d3ad2", imageId: "9f10b52", headingId: "b52ac21", boxed: true, icon: "/icon-mango.svg", name: "dusehri" },
  // Fresh fruit range, kept in step with the live catalogue — flat SVG marks only.
  { id: "6667e8e", imageId: "2080a40", headingId: "158858a", boxed: true, icon: "/icon-guava.svg", name: "guava" },
  { id: "fe3d799", imageId: "ea6f660", headingId: "cc7ef5b", boxed: true, icon: "/icon-cherries.svg", name: "cherries" },
  { id: "4f5f6ed", imageId: "177d812", headingId: "a76ffdf", boxed: true, icon: "/icon-watermelon.svg", name: "watermelon" },
  { id: "50d3ad2", imageId: "9f10b52", headingId: "b52ac21", boxed: true, icon: "/icon-grapes-red.svg", name: "red grapes" },
  { id: "6667e8e", imageId: "2080a40", headingId: "158858a", boxed: true, icon: "/icon-grapes-black.svg", name: "black grapes" },
  { id: "fe3d799", imageId: "ea6f660", headingId: "cc7ef5b", boxed: true, icon: "/icon-lychee.svg", name: "lychee" },
  { id: "4f5f6ed", imageId: "177d812", headingId: "a76ffdf", boxed: true, icon: "/icon-dragonfruit.svg", name: "dragon fruit" },
  { id: "50d3ad2", imageId: "9f10b52", headingId: "b52ac21", boxed: true, icon: "/icon-pomegranate2.svg", name: "pomegranate" },
  { id: "6667e8e", imageId: "2080a40", headingId: "158858a", boxed: true, icon: "/icon-banana.svg", name: "bananas" },
  { id: "fe3d799", imageId: "ea6f660", headingId: "cc7ef5b", boxed: true, icon: "/icon-melon.svg", name: "yellow melon" },
  { id: "4f5f6ed", imageId: "177d812", headingId: "a76ffdf", boxed: true, icon: "/icon-pineapple.svg", name: "honey glow pineapple" },
  { id: "50d3ad2", imageId: "9f10b52", headingId: "b52ac21", boxed: true, icon: "/icon-pear.svg", name: "golden pear" },
  // Vegetables.
  { id: "6667e8e", imageId: "2080a40", headingId: "158858a", boxed: true, icon: "/icon-karela.svg", name: "karela" },
  { id: "fe3d799", imageId: "ea6f660", headingId: "cc7ef5b", boxed: true, icon: "/icon-tomato.svg", name: "tomato" },
  { id: "4f5f6ed", imageId: "177d812", headingId: "a76ffdf", boxed: true, icon: "/icon-mushroom.svg", name: "mushrooms" },
  { id: "50d3ad2", imageId: "9f10b52", headingId: "b52ac21", boxed: true, icon: "/icon-veg-generic.svg", name: "lauki" },
